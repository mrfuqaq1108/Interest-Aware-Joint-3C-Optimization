...
while np.fabs(Cost_max - Cost_opt) > math.pow(10, -12):
    ...
    Cost_opt = Cost_max
    C, D = function_algorithm1.algorithm1(M, N, C_u, Band, a, pw, N0, h_u, p_id, p_com, p_loc, lamda_e, lamda_t, Din, Dout, omg, f_loc, f_c, prob)
    a, Cost_max = function_algorithm2.algorithm2(M, N, C_u, Band, pw, N0, h_u, p_id, p_com, p_loc, lamda_e, lamda_t, Din, Dout, omg, f_loc, f_c, prob, C, D)
    iteration1 += 1
