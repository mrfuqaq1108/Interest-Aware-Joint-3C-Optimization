...
C, D, a, Cost_max, Cost_max_index = function_algorithm3.algorithm3(M, N, C_u, Band, pw, N0, h_u, p_id, p_com, p_loc, lamda_e, lamda_t, Din, Dout, omg, f_loc, f_c, prob_change=real_prob, prob_fixed=real_prob)
print(f"C = \n{C}")
print(f"D = \n{D}")
# print(f"a = \n{a}")
print(f"Cost_max = \n{Cost_max}")
